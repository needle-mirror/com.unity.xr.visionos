...
namespace UnityEngine.XR.VisionOS
{
    ...
    static class NativeApi_Scene_Reconstruction
    {
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_element_get_buffer")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_element_get_count")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_element_get_bytes_per_index")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_element_get_index_count_per_primitive")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_element_get_primitive_type")]
        ...
        /// <returns>The Metal buffer.</returns>
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_source_get_buffer")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "UnityVisionOS_impl_ar_geometry_source_get_buffer")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_source_get_count")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_source_get_format")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_source_get_components_per_vector")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_source_get_offset")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_geometry_source_get_stride")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_mesh_geometry_get_vertices")]
        ...
        /// <param name="mesh_geometry">The mesh geometry.</param>
        /// <returns>An instance of `ar_geometry_source_t`.</returns>
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_mesh_geometry_get_normals")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_mesh_geometry_get_faces")]
        ...
        /// <param name="mesh_geometry">The mesh geometry.</param>
        /// <returns>An instance of `ar_geometry_source_t`.</returns>
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_mesh_geometry_get_classification")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_mesh_anchor_get_geometry")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_mesh_anchors_get_count")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_scene_reconstruction_configuration_create")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_scene_reconstruction_configuration_get_scene_reconstruction_mode")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_scene_reconstruction_configuration_set_scene_reconstruction_mode")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_scene_reconstruction_provider_create")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_scene_reconstruction_provider_get_required_authorization_type")]
