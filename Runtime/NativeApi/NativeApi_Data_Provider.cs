...
namespace UnityEngine.XR.VisionOS
{
    ...
    static class NativeApi_Data_Provider
    {
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_create")]
        ...
        /// This type supports ARC. In non-ARC files, use `ar_retain()` and `ar_release()` to retain and release the object.
        /// </remarks>
        /// <param name="data_provider">Variable number of data providers to add to newly created collection.</param>
        /// <returns>An instance of `ar_data_providers_t`.</returns>
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_create_with_data_providers")]
        public static extern IntPtr ar_data_providers_create_with_data_providers(IntPtr data_provider);
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_add_data_provider")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_add_data_providers")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_remove_data_provider")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_remove_data_providers")]
        ...
        [DllImport(NativeApi_Constants.LibraryName, EntryPoint = "ar_data_providers_get_count")]
